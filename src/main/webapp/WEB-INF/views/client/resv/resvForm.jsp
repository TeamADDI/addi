...
<body>
				...
				<form id="resvForm" action="resvList" method="POST">
					<fieldset>
						...
						<div class="form-check-inline">
							<label class="form-check-label"> <input type="checkbox"
								class="form-check-input" id="cl" name=categories value="CL">진료
							</label>
						</div>
						<div class="form-check-inline">
							<label class="form-check-label"> <input type="checkbox"
								class="form-check-input" id="bt" name="categories" value="BT">미용
							</label>
						</div>
						<div class="form-check-inline">
							<label class="form-check-label"> <input type="checkbox"
								class="form-check-input" id="ca" name="categories" value="CA">돌봄
							</label>
						</div>
					...
					<fieldset>
						...
						<br> <input type="text" id="rPetType" class="form-control"
							...
							required><br> <legend>파트너 크기</legend>
					...
					<div class="row">
						<div class="col">
							<input type="button" class="btn btn-secondary form-control"
								value="예약 취소" onclick="location.href='/'">
						</div>
						<div class="col">
							<input type="button" class="btn btn-dark form-control"
								value="예약 결제" onclick="submitForm()">
						</div>
					</div>
				</form>
			</main>
	...
	function setCategory() {
		...
		const selectBoxes = document.querySelectorAll("input[type='checkbox'][name='categories']");
