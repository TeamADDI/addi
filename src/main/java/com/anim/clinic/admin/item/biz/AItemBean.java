...
public class AItemBean {
	...
	public void setI_sale(float i_sale) {
		this.i_sale = i_sale;
	}
	...
	public String toString() {
		return "AItemBean [item_num=" + item_num + ", item_code=" + item_code + ", i_category=" + i_category
				+ ", item_name=" + item_name + ", i_img=" + i_img + ", i_detail=" + i_detail + ", i_stock=" + i_stock
				+ ", i_price=" + i_price + ", i_sale=" + i_sale + ", i_tax_free=" + i_tax_free + ", i_regdate="
				+ i_regdate + ", i_updatedate=" + i_updatedate + "]";
	}
