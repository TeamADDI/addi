...
public class UserBean {
	...
	public String toString() {
		return "UserVO [u_no=" + u_no + ", u_id=" + u_id + ", u_pw=" + u_pw + ", u_name=" + u_name + ", u_email="
				+ u_email + ", u_tel=" + u_tel + ", u_birth=" + u_birth + ", u_age=" + u_age + ", u_gender=" + u_gender
				+ ", u_post=" + u_post + ", u_addr=" + u_addr + ", u_regdate=" + u_regdate + "]";
	}
