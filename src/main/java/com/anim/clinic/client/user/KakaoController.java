...
public class KakaoController {
	...
	public @ResponseBody String getKakaoAuthUrl(HttpServletRequest request) throws Exception {
		String reqUrl = "https://kauth.kakao.com/oauth/authorize" + "?client_id=b2c0b06d88bec2e81a5416cf30e1f208"
	...
	public String oauthKakao(@RequestParam(value = "code", required = false) String code, Model model)
		...
		return "/client/user/cindex"; // 본인 원하는 경로 설정
	}
	...
	public String getAccessToken(String authorize_code) {
		...
		try {
			...
			sb.append("&client_id=b2c0b06d88bec2e81a5416cf30e1f208"); // 본인이 발급받은 key
